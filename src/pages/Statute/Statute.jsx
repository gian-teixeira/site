...
function Statute(){
    return (
        <div id="statute">
            <p>
                Este estatuto tem como objetivo estabelecer normas para a equipe de maratona de programação do DCOMP/UFSJ.
            </p>

            <h3>DISPOSIÇÕES PRELIMINARES</h3> 

            <p>
                A equipe de maratona de programação do DCOMP/UFSJ foi criada em outubro de 2022 e oficializada pelo departamento 
                na 109a Reunião Ordinária do DCOMP/UFSJ. Os membros fundadores são:
            </p>
            ...
            <p>
                A equipe de maratona de programação do DCOMP/UFSJ tem como finalidade o treinamento para participação de edições da Maratona
                Mineira de Programação e da Maratona Brasileira de Programação. 
            </p>
            ...
            <ul>
                <li> Das vagas
                    <ul>
                        ...
                        <li>Para assumir uma vaga em aberto na equipe, o candidato deverá 
                            cumprir o treinamento básico estipulado no site oficial da equipe 
                ...
                <li> Das obrigações dos membros
                    <ul>
                        ...
                        <li>Comunicar problemas sobre infraestrutura para o coordenador da equipe.</li>
                        <li>Colaborar com os outros membros da equipe.</li>
                        <li>Respeitar e manter a cordialidade no ambiente.</li>
                        <li>Manter bom desempenho acadêmico.</li>
                        <li>Devolver qualquer material disponibilizado se desligado.</li>
            ...
            <p>Os discentes receberão certificado de participação se integrarem a equipe de maratona por, pelo menos, 
                seis meses e participarem de, ao menos, uma competição.</p>

            <h3>DA MUDANÇA DO ESTATUTO</h3>

            <p>Este estatuto poderá ser modificado com aprovação de dois terços de seus membros.</p>
